...
const generateTokenAndSetCookie = require("../utils/helpers/genTokenAndSetCookie");
...
exports.followUnfollowUser = async (req, res) => {
 console.log("inside get follow unfollow")
...
//to update user controller function
...
exports.getSuggestedUSer = async (req,res)=>{
   ...
   try {
    ...
    res.status(500).json(`error : ${error.message}`);
    console.log("Error in getSuggesteduser  function: ", error.message);
   }
}